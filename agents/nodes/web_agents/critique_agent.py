...
# Prompt de critique simple
CRITIQUE_PROMPT = PromptTemplate.from_template("""
Tu es un agent expert en analyse critique. Voici un contenu :
{content}
...
def critique(content: str) -> str:
    prompt_text = CRITIQUE_PROMPT.format(content=content)
    return llm.invoke(prompt_text)

class CritiqueAgent(Runnable):
